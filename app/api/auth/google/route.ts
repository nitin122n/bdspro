...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!code) {
      ...
      googleAuthUrl.searchParams.set('redirect_uri', `${baseUrl}/api/auth/google`);
    ...
    try {
      ...
      try {
        ...
        if (!user) {
          ...
          console.log('JWT tokens created successfully for user:', newUser.user_id);
          ...
          console.log('JWT tokens created successfully for user:', user.user_id);
